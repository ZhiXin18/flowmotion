...
class GeocodingApi {
  ...
  const GeocodingApi(this._dio, this._serializers);
  ...
  ///
  /// Parameters:
  /// * [postcode] - Postal code to retrieve location coordinates for.
  ...
  Future<Response<Location>> geocodePostcodeGet({
    ...
    final _path = r'/geocode/{postcode}'.replaceAll(
        '{' r'postcode' '}',
        encodeQueryParameter(_serializers, postcode, const FullType(String))
            .toString());
