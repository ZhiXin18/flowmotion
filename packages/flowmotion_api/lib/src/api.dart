...
import 'package:flowmotion_api/src/serializers.dart';
import 'package:flowmotion_api/src/auth/api_key_auth.dart';
import 'package:flowmotion_api/src/auth/basic_auth.dart';
...
class FlowmotionApi {
  ...
  /// Get CongestionApi instance, base route and serializer can be overridden by a given but be careful,
  ...
  RoutingApi getRoutingApi() {
    return RoutingApi(dio, serializers);
  }
}
