                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // List of saved places with swipe-to-remove functionality
                      Expanded(
                        child: addresses.isEmpty
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Dismissible(
                              key: Key(address["label"] ?? index.toString()), // Ensure a unique key for each item
                              direction: DismissDirection.endToStart, // Swipe from right to left
                              onDismissed: (direction) {
                                // Remove the address when dismissed
                                setState(() {
                        ...
                        child: AnimatedButton(
                          ...
                          onPress: () async {
                            ...
                            if (allValid) {
                              ...
                              // Show error if any postal code was invalid
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(content: Text('One or more postal codes are invalid')),
                              );
                            }
                          },
                        ),
